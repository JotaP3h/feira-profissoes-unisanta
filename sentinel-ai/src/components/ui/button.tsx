...
/**
 * Botão estilo shadcn/ui — adaptado para o tema SENTINEL AI.
 *
 * Variants extras adicionadas (em relação ao shadcn padrão):
 *  - `navCta`     — botão da navbar
 *  - `hero`       — CTA primário verde do herói
 *  - `heroOutline` — CTA secundário branco do herói
 */
